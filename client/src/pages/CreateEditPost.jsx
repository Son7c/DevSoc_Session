  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-24 pb-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form
          onSubmit={onSubmit}
          className="bg-white rounded-3xl shadow-xl shadow-gray-100/50 border border-gray-100 p-8 sm:p-12 space-y-8"
        >
          <div className="space-y-2">
            ...
            <input
              ...
              onChange={onChange}
              required
              className="w-full px-0 py-4 border-b-2 border-gray-100 text-3xl sm:text-4xl font-serif font-bold text-gray-900 focus:border-black focus:outline-none transition-colors placeholder-gray-300"
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              onChange={onChange}
              required
              className="w-full px-6 py-6 bg-gray-50 rounded-2xl border-0 text-lg text-gray-800 leading-relaxed focus:ring-2 focus:ring-black/5 transition-all resize-y placeholder-gray-400"
